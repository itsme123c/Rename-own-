This Telegram bot allows users to rename the bot and set a custom thumbnail image. It provides a simple interface for managing the bot's name and visual identity.
